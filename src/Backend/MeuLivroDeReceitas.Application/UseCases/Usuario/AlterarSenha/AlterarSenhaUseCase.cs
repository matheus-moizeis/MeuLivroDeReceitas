...
public class AlterarSenhaUseCase : IAlterarSenhaUseCase
{
    ...
    public async Task Executar(RequisicaoAlteraSenhaJson requisicao)
    {
    ...
    private void Validar(RequisicaoAlteraSenhaJson requisicao, Domain.Entidades.Usuario usuario) 
    {
